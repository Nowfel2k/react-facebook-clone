  ...
  return (
    <div className="request">
      <Avatar
        ...
        src={`https://avatars.dicebear.com/api/avataaars/${seed}.svg?options[mouth][]=smile`}
      />
      <div className="request__info">
        ...
        <div className="request__buttons">
          <button className="request__accept">Accept</button>
          <button className="request__delete">Delete</button>
        </div>
      </div>
    </div>
  );
